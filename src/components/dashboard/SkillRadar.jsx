...
function SkillRadar() {
  return (
    <div className="bg-[#06090f] border border-white/10 p-8 h-full flex flex-col">
        ...
        {skills.map((skill, i) => (
          <div key={i}>
            ...
            <div className="h-1 bg-white/5 rounded-full overflow-hidden">
              <div
                className="h-full bg-[#378079] rounded-full transition-all duration-1000"
      ...
      <div className="mt-6 pt-6 border-t border-white/5">
        ...
        <p className="text-[#378079] font-black text-2xl mt-1">Junior Dev</p>
      </div>
    </div>
  );
}
