...
function LanguageFamilyTree() {
    const LANG_FAMILIES = [
        { family: 'Hind-Avropa', color: '#378079', members: ['İngilis', 'Alman', 'Fransız', 'İspan', 'Rus', 'Hind', 'Farsi', 'Yunan'], origin: 'Proto-Hind-Avropa (5000 il əvvəl, Pont çölləri)' },
        { family: 'Türk', color: '#9a7a2a', members: ['Azərbaycanca', 'Türkcə', 'Özbəkcə', 'Qazaxca', 'Uyğurca', 'Türkmən'], origin: 'Orta Asiya çölləri (2500 il əvvəl)' },
    ...
    const fam = LANG_FAMILIES[active];

    return (
        <section className="px-8 md:px-16 py-16 border-t border-white/5 bg-[#06090f]">
            <div className="flex items-center gap-2 mb-4">
                <div className="w-6 h-px bg-[#378079]" />
                <span className="text-[9px] tracking-[0.3em] text-[#378079] uppercase font-bold tracking-[0.4em]">Etimalogiya</span>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                <div className="bg-[#0b0f17] border rounded-3xl p-8 relative overflow-hidden transition-all duration-700" style={{ borderColor: `${fam.color}30` }}>
                ...
                <div className="bg-[#0b0f17] border border-white/5 rounded-3xl p-10 flex flex-col items-center justify-center min-h-[350px] relative">
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                        <div className="px-8 py-4 rounded-full text-sm font-black uppercase tracking-[0.2em] shadow-2xl"
                        ...
                        <div className="relative flex flex-wrap justify-center gap-4 max-w-md mt-[-1px]">
