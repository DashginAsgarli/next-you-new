    ...
    <div className="group relative bg-[#0a0e14] border border-white/4 hover:border-[#378079]/40 transition-all duration-500 overflow-hidden">
      ...
      <div className="relative z-10 p-2.5">
        ...
        <div className="relative aspect-[3/3.6] overflow-hidden border border-white/5 bg-black shadow-2xl">
          ...
          <img src={book.cover} alt={book.title} className="w-full h-full object-cover grayscale group-hover:grayscale-0 group-hover:scale-110 transition-all duration-[1.2s] ease-in-out opacity-80 group-hover:opacity-100" />

          <button onClick={(e) => { e.stopPropagation(); toggleFavorite(book.id); }} className={`absolute top-2 left-2 p-2 backdrop-blur-xl border transition-all duration-300 z-30 ${isFavorite ? 'bg-[#378079] border-[#378079] text-[#06090f] shadow-[0_0_10px_#378079]' : 'bg-white/3 border-white/10 text-white/30 hover:text-white'}`}>
