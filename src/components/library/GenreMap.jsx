        ...
        <section className="px-8 md:px-16 py-10 border-t border-white/5">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    {genres.map(g => {
                        ...
                        return (
                            <button
                                ...
                                className={'border rounded-2xl font-black tracking-[0.15em] uppercase transition-all ' + sizes[g.size]}
                                style={{
                                    borderColor: isActive ? g.color : 'rgba(255,255,255,0.06)',
                                    background: isActive ? g.color + '20' : '#0b0f17',
                                    color: isActive ? g.color : 'rgba(240,235,226,0.5)',
                                }}
                            >
                                {g.label}
                ...
                <div>
                    {selected ? (
                        <div
                            className="bg-[#0b0f17] rounded-2xl p-6 md:p-8 border transition-all"
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {selected.sub.map(s => (
                                            <span
                                                ...
                                                style={{ borderColor: selected.color + '30', color: selected.color }}
                                            >
                                                {s}
                                            </span>
                                        ))}
